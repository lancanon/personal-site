          ...
          {TIMELINE.map((job) => (
            ...
            >
              <Spotlight
                ...
                size={64}
              />
              <div className="relative h-full w-full rounded-[15px] bg-white p-4 dark:bg-[#161e27]">
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {PROJECTS.map((project) => (
            ...
            >
              <div className="font-base relative inline-block font-[450] text-zinc-900 dark:text-zinc-50 group-hover:text-blue-600 transition-colors">
                {project.name}
              </div>
